...
public class SellProductResponseData implements Serializable {
    ...
    @SerializedName("broken_ratio")
    @Expose
    private String brokenRatio;
    ...
    @SerializedName("delivery_location_state")
    @Expose
    ...
    @SerializedName("other_image1")
    @Expose
    private String otherImage1;
    @SerializedName("other_image2")
    @Expose
    private String otherImage2;
    @SerializedName("other_image3")
    @Expose
    private String otherImage3;
    @SerializedName("other_image4")
    @Expose
    ...
    public String getBrokenRatio() {
        return brokenRatio;
    }

    public void setBrokenRatio(String brokenRatio) {
    ...
    public String getGrainLength() {
        return grainLength;
    }

    public void setGrainLength(String grainLength) {
    ...
    public String getSellProductImageId() {
        return sellProductImageId;
    }

    public void setSellProductImageId(String sellProductImageId) {
        this.sellProductImageId = sellProductImageId;
    }
    ...
    public void setCertificatonAgencyName(String certificatonAgencyName) {
