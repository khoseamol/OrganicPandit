...
public class SearchData {
    ...
    @SerializedName("ecommerce_brand_id")
    @Expose
    ...
    @SerializedName("duration_effect")
    @Expose
    private String durationEffect;
    @SerializedName("frequency_application")
    @Expose
    private String frequencyApplication;
    @SerializedName("applicable_crops")
    @Expose
    ...
    public String getEcommerceBrandId() {
        return ecommerceBrandId;
    }

    public void setEcommerceBrandId(String ecommerceBrandId) {
    ...
    public void setDurationEffect(String durationEffect) {
        this.durationEffect = durationEffect;
    }

    public String getFrequencyApplication() {
        return frequencyApplication;
    }

    public void setFrequencyApplication(String frequencyApplication) {
        this.frequencyApplication = frequencyApplication;
    }
