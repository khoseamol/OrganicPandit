...
import com.everlastingseo.organicpandit.pojo.fetchuserdata_details.UserSoilList;

import java.util.List;

public class FiveUserSoilDetailsAdapter extends RecyclerView.Adapter<FiveUserSoilDetailsAdapter.ViewHolder> {
    Context mContext;
    List<UserSoilList> userCropList;

    public FiveUserSoilDetailsAdapter(Context mContext, List<UserSoilList> userCropList) {
